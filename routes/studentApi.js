...
router.post('/', (req, res, next) => {
    ...
    pool.query(sql1, (err, result) => {
        if (err) {
            ...
            var university_id = result[0]['university_id'];
            const { full_name, nationality, collage, study_field, birth_place, gender, passport_end_date, phone, email, birth_date, location, passport_id, Section, Scientific_level, health_status, study_year, total_study_year, fluency_in_English, total_hour } = req.body;
